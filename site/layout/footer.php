        ...
        <div class="modal fade" id="modal-register" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="index.php?c=customer&a=register" method="POST" role="form">
                        <div class="modal-body">
                            ...
                            <div class="form-group g-recaptcha" data-sitekey="6LddhskZAAAAANReVLPPP83VuhbJ2S8f9WzvrYFz"></div>
                            <input type="hidden" name="reference" value="<?=get_full_url() ?>">
                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header bg-color">
                        ...
                        <div class="text-center">
                            ...
                            $redirectUri = "https://" . get_domain() . $_SERVER['PHP_SELF'] . "?c=auth&a=loginGoogle";
                            ...
                            $fb = new Facebook\Facebook([
                                ...
                                $callback = "https://" . get_domain() . $_SERVER['PHP_SELF'] . "?c=auth&a=loginFacebook";
        ...
        <div class="modal fade" id="modal-forgot-password" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="index.php?c=customer&a=forgotPW" method="POST" role="form">
                        <div class="modal-body">
                            <div class="form-group">
