...
<html>
    <head>
        <title><?= !empty($page_title) ? $page_title : "Godashop" ?></title>
        <meta charset="utf-8">
                        ...
                        <ul class="list-inline pull-right top-right">
                            <li class="account-login">
                                ...
                                if (!empty($_SESSION["email"])) {
                                 ?>
                                   <a href="index.php?c=order&a=list" class="btn-logout">Đơn hàng của tôi</a>
                                <?php }
                                else  {
                                ?>
                            ...
                            <li>
                                <?php if (!empty($_SESSION["email"])) { ?>
                                   <a href="javascript:void(0)" class="btn-account dropdown-toggle" data-toggle="dropdown" id="dropdownMenu"><?=$_SESSION["name"]?></a>
                                    ...
                                    <li><a href="index.php?c=customer&a=infoAccount">Thông tin tài khoản</a></li>
                                    <li><a href="index.php?c=customer&a=shippingAddress">Địa chỉ giao hàng</a></li>
                                    <li><a href="/index.php?c=customer&a=infoAccount">Đơn hàng của tôi</a></li>
