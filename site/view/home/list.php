        ...
        <main id="maincontent" class="page-main">
            <div class="container">
                ...
                <?php 
                    foreach ($productByCategories as $productByCategory) {
                ?>
                <div class="row equal">
                    <div class="col-xs-12">
                        <h4 class="home-title"><?=$productByCategory["category_name"]?></h4>
                    </div>
                   <?php foreach ($productByCategory["products"] as $product) {
