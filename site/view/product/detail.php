                ...
                <div class="col-md-6">
                    ...
                    <div class="product-detail-carousel-slider">
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item thumbnail"><img src="../upload/<?=$imageItem->getName()?>" alt=""></div>
                            <?php  } ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12">
                    <div role="tabpanel">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="product-description">   <?=$product->getDescription()?>           
                            </div>
